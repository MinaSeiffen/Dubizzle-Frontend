...
function ProductDetailsFooter({product}) {
  const [isShow , setIsShow] = useState(false)
  const handleShowPhone = () => {
    setIsShow(!isShow);
  }
  return (
    <div className="-mt-px p-3 flex justify-center h-fit  bg-white ">
          ...
          {(product?.contact_type.includes("both") ||
            ...
            <div className="flex  h-[40px] mx-2 justify-center cursor-pointer items-center bg-red-300 rounded-lg hover:bg-red-400">
              <span
                className="relative -mr-px inline-flex w-[100px] flex-1 items-center justify-center gap-x-1 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-gray-900"
              ...
              >
                ...
                {isShow ? product?.phoneNumber : "Call" }
