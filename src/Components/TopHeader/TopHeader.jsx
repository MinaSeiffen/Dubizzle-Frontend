...
export default function TopHeader() {
    ...
    return (
        <div className="sm:border-none border-b-2">
            <div className="md:container mb-4 mt-1  flex justify-start ">
                <button
                ...
                <div className="flex ">
                    ...
                    >
                        <span
                            className="text-x flex  ms-4 me-2" style={{ borderRadius: "80%", background: "#fef5f5" }}>
